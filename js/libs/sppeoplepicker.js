(function ($) {
    ...
    function initializePeoplePicker(eleId, onResolved,allowMultiple) {
        // Create a schema to store picker properties, and set the properties.
        var canAllowMultiple=(allowMultiple==undefined)?true:false;
        var schema = {};
        ...
        schema['Width'] = 'auto';
        schema['OnUserResolvedClientScript'] = function (eleId, userKey) {
	        onResolved(userKey);	    
	    };
    ...
    function GetPeoplePickerUserKeys(eleId) {
        var toSpanKey = eleId + "_TopSpan";
        var peoplePicker = null;
        ...
        if (peoplePicker != null) {
            // Get information about all users.
            var users = peoplePicker.GetAllUserKeys();
            return users;
        }
        else
            return '';
	...
	function GetPeoplePickerUsers(eleId) {
        var toSpanKey = eleId + "_TopSpan";
        var peoplePicker = null;
    ...
    function SetPeoplePickerUser(userName) {
        
    }



    $.fn.spPeoplePicker = function (onResolved,allowMultiple) {
        var eleId = $(this).attr('id');
        ExecuteOrDelayUntilScriptLoaded(function () { initializePeoplePicker(eleId, onResolved,allowMultiple); }, 'sp.core.js');
    };
    ...
    $.fn.getUserKeys = function () {
        var eleId = $(this).attr('id');
        return GetPeoplePickerUserKeys(eleId);
    }
    
    $.fn.getUsers = function () {
        var eleId = $(this).attr('id');
        return GetPeoplePickerUsers(eleId);
    }

	$.fn.setUser = function(userName) {
		var eleId = $(this).attr('id');
		SetPeoplePickerUser(userName);
	}
